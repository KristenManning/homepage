...
$.ajax({url: weather_url, method: 'GET'}).done(function(result) {
  ...
  $("#weather").append("<b>" + city + " <br><br>Now</b><br> " + result.list[0].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 3 Hours</b><br>" + result.list[1].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 6 Hours</b><br>" + result.list[2].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 9 Hours</b><br>" + result.list[3].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 12 Hours</b><br>" + result.list[4].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 15 Hours</b><br>" + result.list[5].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 18 Hours</b><br>" + result.list[6].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 21 Hours</b><br>" + result.list[7].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
  $("#weather").append("<b>In 24 Hours</b><br>" + result.list[8].weather[0].description + "<br>" + faren + " Degrees Farenheit <br><br>")
