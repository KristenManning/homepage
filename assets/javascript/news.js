$(document).ready(function() {
	...
	var display_news = function(){
		...
		$.ajax({url: nyt_url1, method: 'GET'}).done(function(result) {
		  ...
		  $(".s2a").html("")
		  $(".s2a").append("<div class='row'><div class='col-md-12'><h2>" + topic1 + "</h2></div></div>")
		  for (var i = 0; i <5; i++) {
		    var current_result = result.results[i]
		    $(".s2a").append("<div class='row'> <div class='col-md-1'></div> <div class='col-md-1'> <img src="+current_result.multimedia[0].url+"></div> <div class='col-md-9'> <b> <a href="+ current_result.url + ">" + current_result.title + "</a></b><br>" + current_result.byline + "<br><i>" + current_result.abstract + "</i><br><br></div></div>")
		  }
